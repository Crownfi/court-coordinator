...
import { ClientEnv, MaybeSelectedProviderString, getDefaultNetworkConfig, getNetworkConfig, setDefaultNetwork } from "@crownfi/sei-utils";
...
export async function askUserForWallet() {
	...
	const newProvider = userChoice == "read-only-address" ?
