...
export class CourtConfigRefs {
	...
	#totalVoteTokens?: TokenDisplayElement;
	get totalVoteTokens() {
		if (this.#totalVoteTokens === undefined) {
			this.#totalVoteTokens = this.#element.querySelector("[cewt-ref=\"total-vote-tokens\"]:not(:scope [is] *)")!;
		}
		return this.#totalVoteTokens;
	}
	...
	#configMinVotesNewAmountTokens?: TokenDisplayElement;
	get configMinVotesNewAmountTokens() {
		if (this.#configMinVotesNewAmountTokens === undefined) {
			this.#configMinVotesNewAmountTokens = this.#element.querySelector("[cewt-ref=\"config-min-votes-new-amount-tokens\"]:not(:scope [is] *)")!;
		}
		return this.#configMinVotesNewAmountTokens;
	}
	...
	#configMinTurnoutTokens?: TokenDisplayElement;
	get configMinTurnoutTokens() {
		if (this.#configMinTurnoutTokens === undefined) {
			this.#configMinTurnoutTokens = this.#element.querySelector("[cewt-ref=\"config-min-turnout-tokens\"]:not(:scope [is] *)")!;
		}
		return this.#configMinTurnoutTokens;
	}
